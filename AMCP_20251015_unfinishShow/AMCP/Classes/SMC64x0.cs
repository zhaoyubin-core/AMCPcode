...
namespace AMCP
{
    ...
    class SMC6X
    {
        public static IntPtr phandle; // 卡链接
        ...
        *************************************************************/
        ...
        public static extern Int32 SMCVectMoveLineN(IntPtr phandle, Byte itotalaxis, Byte[] piaxisList, double[] DistanceList, double dspeed, Byte bIfAbs);
        ...
        **********************************************************************/
        ...
        public static double M2U = 500; //5;   //5.34;     //5.376344086;       unit/mm
        public static double M2P = 100; //107;     //5.376344086;       unit/mm

        const int CMDDELAY = 300;
        ...
        /// 设置单轴运动速度（mm/s）
        /// </summary>
        public static Int32 SetSpeed(IntPtr phandle, Byte iaxis, double speed)
        {
            return SMCSetLocateSpeed(phandle, iaxis, (int)(speed * M2U));
        }

        public static Int32 SetSpeed(Byte iaxis, double speed)
        {
            return SetSpeed(phandle, iaxis, speed);
        }

        /// <summary>
        /// 设置单轴运动速度（mm/s）
        /// </summary>
        public static Int32 SetHomeSpeed(IntPtr phandle, Byte iaxis, double speed)
        {
            return SMCSetZeroSpeed(phandle, iaxis, (int)(speed * M2U));
        }

        public static Int32 SetHomeSpeed(Byte iaxis, double speed)
        {
            return SetHomeSpeed(phandle, iaxis, speed);
        }

        /// <summary>
        /// 设置单轴运动加速度（mm/s^2）
        /// </summary>
        public static Int32 SetAcceleration(IntPtr phandle, Byte iaxis, double speed)
        {
            return SMCSetLocateAcceleration(phandle, iaxis, (int)(speed * M2U));
        }

        public static Int32 SetAcceleration(Byte iaxis, double speed)
        {
            return SetAcceleration(phandle, iaxis, speed);
        }

        /// <summary>
        /// 设置单轴运动减速度（mm/s^2）
        /// </summary>
        public static Int32 SetDeceleration(IntPtr phandle, Byte iaxis, double speed)
        {
            return SMCSetLocateDeceleration(phandle, iaxis, (int)(speed * M2U));
        }

        public static Int32 SetDeceleration(Byte iaxis, double speed)
        {
            return SetDeceleration(phandle, iaxis, speed);
        }

        /// <summary>
        /// 获取单轴位置（mm）
        /// </summary>
        public static double GetPosition(IntPtr phandle, Byte iaxis, ref double position)
        {
            double pposition = 0;
            Int32 returnValue = SMCGetPosition(phandle, iaxis, ref pposition);
            position = pposition / M2U;
            return returnValue;
        }

        public static double GetPosition(Byte iaxis, ref double position)
        {
            return GetPosition(phandle, iaxis, ref position);
        }

        /// <summary>
        /// 获取单轴设定速度
        /// </summary>
        public static double GetSpeedSet(IntPtr phandle, Byte iaxis, ref double mmSpeed)
        {
            int veloSet = 0;
            Int32 returnValue = SMCGetLocateSpeed(phandle, iaxis, ref veloSet);
            mmSpeed = veloSet / M2U;
            return returnValue;
        }

        public static double GetSpeedSet(Byte iaxis, ref double mmSpeed)
        {
            return GetSpeedSet(phandle, iaxis, ref mmSpeed);
        }

        /// <summary>
        /// 获取单轴当前速度（mm/s）
        /// </summary>
        public static double GetCurSpeed(IntPtr phandle, Byte iaxis, ref double speed)
        {
            double pspeed = 0;
            Int32 returnValue = SMCGetCurSpeed(phandle, iaxis, ref pspeed);
            speed = pspeed / M2U;
            return returnValue;
        }

        public static double GetCurSpeed(Byte iaxis, ref double speed)
        {
            return GetCurSpeed(phandle, iaxis, ref speed);
        }

        /// <summary>
        /// 单轴移动一个指定步长
        /// </summary>
        public static void MoveStep(IntPtr phandle, Byte iaxis, double dlength)
        {
            SMCPMove(phandle, iaxis, dlength * M2U, 0);
            Thread.Sleep(CMDDELAY);
        }

        public static void MoveStep(Byte iaxis, double dlength)
        {
            MoveStep(phandle, iaxis, dlength);
        }

        public static void MoveStep(IntPtr phandle, Byte iaxis, double Distance, double dspeed)
        {
            SMCVectMoveStart(phandle);
            SMCVectMoveLine1(phandle, iaxis, Distance * M2U, dspeed * M2U, 0);
            SMCVectMoveEnd(phandle);
            Thread.Sleep(CMDDELAY);
        }

        public static void MoveStep(Byte iaxis, double Distance, double dspeed)
        {
            MoveStep(phandle, iaxis, Distance, dspeed);
        }

        /// <summary>
        /// 单轴移动到指定的绝对坐标
        /// </summary>
        public static void MoveAbs(IntPtr phandle, Byte iaxis, double pos)
        {
            SMCPMove(phandle, iaxis, pos * M2U, 1);
            Thread.Sleep(CMDDELAY);
        }

        public static void MoveAbs(Byte iaxis, double pos)
        {
            MoveAbs(phandle, iaxis, pos);
        }

        public static void MoveAbs(IntPtr phandle, Byte iaxis, double pos, double speed)
        {
            SMCVectMoveStart(phandle);
            SMCVectMoveLine1(phandle, iaxis, pos * M2U, speed * M2U, 1);
            SMCVectMoveEnd(phandle);
            Thread.Sleep(CMDDELAY);
        }

        public static void MoveAbs(Byte iaxis, double pos, double speed)
        {
            MoveAbs(phandle, iaxis, pos, speed);
        }

        /// <summary>
        /// XYZ插补运动
        /// </summary>
        public static Int32 VectMoveLineXYZ(IntPtr phandle, double x, double y, double z, double speed)
        {
            Byte itotalaxis = 3;
            Byte[] piaxisList = { 0, 1, 2 };
            double[] DistanceList = new double[3];
            DistanceList[0] = x * M2U;
            DistanceList[1] = y * M2U;
            DistanceList[2] = z * M2U;
            return SMCVectMoveLineN(phandle, itotalaxis, piaxisList, DistanceList, speed * M2U, 1);
        }

        public static Int32 VectMoveLineXYZ(double x, double y, double z, double speed)
        {
            return VectMoveLineXYZ(phandle, x, y, z, speed);
        }
        ...
        public static void WaitMoveEnd(IntPtr phandle)
        {
            byte bIfDown = 0;
            while (true)
            {
                SMCCheckDown(phandle, 0, ref bIfDown);
                if (bIfDown == 0)
                {
                    Thread.Sleep(10);
                }
            ...
            while (true)
            {
                SMCCheckDown(phandle, 1, ref bIfDown);
                if (bIfDown == 0)
                {
                    Thread.Sleep(10);
                }
            ...
            while (true)
            {
                SMCCheckDown(phandle, 2, ref bIfDown);
                if (bIfDown == 0)
                {
                    Thread.Sleep(10);
                }
        ...
        public static void WaitMoveEnd()
        {
            WaitMoveEnd(phandle);
        }
        ...
        /// 插补运动开始
        /// </summary>
        public static void VectMoveStart()
        {
            SMCVectMoveStart(phandle);
        }
        ...
        /// 插补运动结束
        /// </summary>
        public static void VectMoveEnd()
        {
            SMCVectMoveEnd(phandle);
        }
        ...
        /// 单轴直线插补（mm）
        /// </summary>
        public static void VectMoveLine1(IntPtr phandle, Byte iaxis, double Distance, double dspeed, Byte bIfAbs)
        {
            SMCVectMoveLine1(phandle, iaxis, Distance * M2U, dspeed * M2U, bIfAbs);
            Thread.Sleep(CMDDELAY);
        }

        public static void VectMoveLine1(Byte iaxis, double Distance, double dspeed, Byte bIfAbs)
        {
            VectMoveLine1(phandle, iaxis, Distance, dspeed, bIfAbs);
        }

        // XY轴直线插补
        public static void VectMoveLineXY(IntPtr phandle, double X, double Y, double dspeed)
        {
            SMCVectMoveLine2(phandle, 0, X * M2U, 1, Y * M2U, dspeed * M2U, 1);
            Thread.Sleep(CMDDELAY);
        }

        public static void VectMoveLineXY(double X, double Y, double dspeed)
        {
            VectMoveLineXY(phandle, X, Y, dspeed);
        }

        // 多轴直线插补
        public static void VectMoveLineN(IntPtr phandle, Byte itotalaxis, Byte[] piaxisList, double[] DistanceList, double dspeed, Byte bIfAbs)
        {
            double[] DistanceList_MM = new double[DistanceList.Length];
            double dspeed_MM = dspeed * M2U;
            for (int i = 0; i < DistanceList.Length; i++)
            {
                DistanceList_MM[i] = DistanceList[i] * M2U;
            }
            SMCVectMoveLineN(phandle, itotalaxis, piaxisList, DistanceList_MM, dspeed_MM, bIfAbs);
            Thread.Sleep(CMDDELAY);
        }

        public static void VectMoveLineN(Byte itotalaxis, Byte[] piaxisList, double[] DistanceList, double dspeed, Byte bIfAbs)
        {
            VectMoveLineN(phandle, itotalaxis, piaxisList, DistanceList, dspeed, bIfAbs);
        }

        // XY轴圆弧插补
        public static void VectMoveArc(IntPtr phandle, double X, double Y, double CenterX, double CenterY, bool bIfClockwise, double dspeed)
        {
            if (bIfClockwise)
            {
                SMCVectMoveArc(phandle, 0, 1, X * M2U, Y * M2U, CenterX * M2U, CenterY * M2U, 0, dspeed * M2U, 1);
            }
            else
            {
                SMCVectMoveArc(phandle, 0, 1, X * M2U, Y * M2U, CenterX * M2U, CenterY * M2U, 1, dspeed * M2U, 1);
            }
            Thread.Sleep(CMDDELAY);
        }

        public static void VectMoveArc(double X, double Y, double CenterX, double CenterY, bool bIfClockwise, double dspeed)
        {
            VectMoveArc(phandle, X, Y, CenterX, CenterY, bIfClockwise, dspeed);
        }

        /// <summary>
        /// 打开端口
        /// </summary>
        public static void OpenPort(IntPtr phandle, int PortID)
        {
            Int32 IoMask = (int)Math.Pow(2, PortID - 1); // 16777215;
            Int32 IoState = 0;
            SMC6X.SMCWriteOutPort(phandle, IoMask, IoState);
        }

        public static void OpenPort(int PortID)
        {
            OpenPort(phandle, PortID);
        }

        /// <summary>
        /// 关闭端口
        /// </summary>
        public static void ClosePort(IntPtr phandle, int PortID)
        {
            Int32 IoMask = (int)Math.Pow(2, PortID - 1); // 16777215;
            Int32 IoState = IoMask;
            SMC6X.SMCWriteOutPort(phandle, IoMask, IoState);
        }

        public static void ClosePort(int PortID)
        {
            ClosePort(phandle, PortID);
        }

        public static bool ReadOutPort(int PortID)
        {
            byte ploState = 0;
            SMC6X.SMCReadOutBit(phandle, PortID, ref ploState);
            return (ploState == 0);
        }
        ...
        /// 移动到指定XYZ坐标
        /// </summary>
        public static void Move2XYZ(IntPtr phandle, double xPos, double yPos, double zPos, double speed)
        {
            if (xPos != -1 && yPos != -1 && zPos != -1)
            {
                Byte[] axisList = { 0, 1, 2 };
                double[] distList = { xPos, yPos, zPos };
                SMCVectMoveStart(phandle);
                VectMoveLineN(phandle, 3, axisList, distList, speed, 1);
                SMCVectMoveEnd(phandle);
            }
            else if (xPos != -1 && yPos != -1 && zPos == -1)
            {
                Byte[] axisList = { 0, 1 };
                double[] distList = { xPos, yPos };
                SMCVectMoveStart(phandle);
                VectMoveLineN(phandle, 2, axisList, distList, speed, 1);
                SMCVectMoveEnd(phandle);
            }
            else if (xPos != -1 && yPos == -1 && zPos != -1)
            {
                Byte[] axisList = { 0, 2 };
                double[] distList = { xPos, zPos };
                SMCVectMoveStart(phandle);
                VectMoveLineN(phandle, 2, axisList, distList, speed, 1);
                SMCVectMoveEnd(phandle);
            }
            ...
            {
                Byte[] axisList = { 0 };
                double[] distList = { xPos };
                SMCVectMoveStart(phandle);
                VectMoveLineN(phandle, 1, axisList, distList, speed, 1);
                SMCVectMoveEnd(phandle);
            }
            else if (xPos == -1 && yPos != -1 && zPos == -1)
            {
                Byte[] axisList = { 1 };
                double[] distList = { yPos };
                SMCVectMoveStart(phandle);
                VectMoveLineN(phandle, 1, axisList, distList, speed, 1);
                SMCVectMoveEnd(phandle);
            }
        ...
        public static void Move2XYZ(double xPos, double yPos, double zPos, double speed)
        {
            Move2XYZ(phandle, xPos, yPos, zPos, speed);
        }


        public static void JogStop(byte axis)
        {
            SMC6X.SMCDecelStop(phandle, axis);
        }

        public static void JogPos(byte axis)
        {
            SMC6X.SMCVMove(phandle, axis, 1);
        }

        public static void JogNeg(byte axis)
        {
            SMC6X.SMCVMove(phandle, axis, 0);
        }
    }
